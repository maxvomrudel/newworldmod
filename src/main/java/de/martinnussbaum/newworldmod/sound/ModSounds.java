package de.martinnussbaum.newworldmod.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, newworldmod.MOD_ID);
    ...
    public static RegistryObject<SoundEvent> BAR_BRAWL = registerSoundEvent("citrine_bar_brawl");
    ...
    private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> new SoundEvent(new ResourceLocation(newworldmod.MOD_ID, name)));
    }
